# Searchable PDF Demo
Demonstrates using OCR and our PdfTranslator to create a searchable PDF using our PdfTranslator and [GlyphReaderEngine](https://www.atalasoft.com/kb2/KB/50125/INFO-GlyphReader-Engine-Overview).  

This is the VB.NET version. We also offer a [C# version]( https://github.com/AtalaSupport/DemoGallery_Desktop_SearchablePdfDemo_CS_x64).  
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_SearchablePdfDemo_VB_x64.git SearchablePdfDemo --recursive
